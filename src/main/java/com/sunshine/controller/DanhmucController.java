...
import com.sunshine.service.DanhmucService;
...
public class DanhmucController {
	...
	@PostMapping("/add")
	public String save(@RequestBody Danhmuc p, Model model) {
	...
	public String save(@RequestBody Danhmuc p, @PathVariable int id, Model model) {
		p.setIddm(id);
