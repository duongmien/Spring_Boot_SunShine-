...
import com.sunshine.service.DiachiService;
...
public class DiachiController {
	...
	@PostMapping("/add")
	public String save(@RequestBody Diachi p, Model model) {
	...
	public String save(@RequestBody Diachi p, @PathVariable int id, Model model) {
		p.setIddc(id);
